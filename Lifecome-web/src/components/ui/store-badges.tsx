...
function AppleMark() {
  return (
    <svg aria-hidden viewBox="0 0 24 24" className="size-7 shrink-0" fill="currentColor">
...
export function AppStoreBadge() {
  return <Badge mark={<AppleMark />} kicker="Coming soon on the" name="App Store" />;
}

export function GooglePlayBadge() {
  return <Badge mark={<GooglePlayMark />} kicker="Coming soon on" name="Google Play" />;
}
